#!/usr/bin/env python3
"""Exact lower-bound certificate for a 36-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 338.8858
for the explicit 36-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0510905726054658"), Q("0.3160017970007036")),
    (Q("0.9489094273945342"), Q("0.3160017970007036")),
    (Q("0.0510905726054658"), Q("0.6839982029992964")),
    (Q("0.9489094273945342"), Q("0.6839982029992964")),
    (Q("0.0646309700388639"), Q("0.0208842588594468")),
    (Q("0.9353690299611361"), Q("0.0208842588594468")),
    (Q("0.0646309700388639"), Q("0.9791157411405532")),
    (Q("0.9353690299611361"), Q("0.9791157411405532")),
    (Q("0.0608135230762119"), Q("0.1565024207264377")),
    (Q("0.9391864769237881"), Q("0.1565024207264377")),
    (Q("0.0608135230762119"), Q("0.8434975792735623")),
    (Q("0.9391864769237881"), Q("0.8434975792735623")),
    (Q("0.2556097991711321"), Q("0.0238108606413147")),
    (Q("0.7443902008288679"), Q("0.0238108606413147")),
    (Q("0.2556097991711321"), Q("0.9761891393586853")),
    (Q("0.7443902008288679"), Q("0.9761891393586853")),
    (Q("0.2707540857715647"), Q("0.2343890787647693")),
    (Q("0.7292459142284353"), Q("0.2343890787647693")),
    (Q("0.2707540857715647"), Q("0.7656109212352307")),
    (Q("0.7292459142284353"), Q("0.7656109212352307")),
    (Q("0.5000000000000000"), Q("0.0368638840918297")),
    (Q("0.5000000000000000"), Q("0.9631361159081703")),
    (Q("0.5000000000000000"), Q("0.0418638840917314")),
    (Q("0.5000000000000000"), Q("0.9581361159082686")),
    (Q("0.5000000000000000"), Q("0.0468638840920026")),
    (Q("0.5000000000000000"), Q("0.9531361159079974")),
    (Q("0.5000000000000000"), Q("0.2961568538296787")),
    (Q("0.5000000000000000"), Q("0.7038431461703213")),
    (Q("0.0220735596540274"), Q("0.5000000000000000")),
    (Q("0.9779264403459726"), Q("0.5000000000000000")),
    (Q("0.2235716838046811"), Q("0.5000000000000000")),
    (Q("0.7764283161953189"), Q("0.5000000000000000")),
    (Q("0.2572664701977679"), Q("0.5000000000000000")),
    (Q("0.7427335298022321"), Q("0.5000000000000000")),
    (Q("0.3662468679166530"), Q("0.5000000000000000")),
    (Q("0.6337531320833470"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 36
assert len(set(LIGHTS)) == 36

WITNESS_POINT: Point = (Q("0.3907790351199106"), Q("0.1844577507203090"))
