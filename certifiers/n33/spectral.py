#!/usr/bin/env python3
"""Exact lower-bound certificate for a 33-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 311.6655
for the explicit 33-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0604088125323088"), Q("0.3174818190186191")),
    (Q("0.9395911874676912"), Q("0.3174818190186191")),
    (Q("0.0604088125323088"), Q("0.6825181809813809")),
    (Q("0.9395911874676912"), Q("0.6825181809813809")),
    (Q("0.0688997342298830"), Q("0.0169923180960170")),
    (Q("0.9311002657701170"), Q("0.0169923180960170")),
    (Q("0.0688997342298830"), Q("0.9830076819039830")),
    (Q("0.9311002657701170"), Q("0.9830076819039830")),
    (Q("0.0619382336060747"), Q("0.1561236763994928")),
    (Q("0.9380617663939253"), Q("0.1561236763994928")),
    (Q("0.0619382336060747"), Q("0.8438763236005072")),
    (Q("0.9380617663939253"), Q("0.8438763236005072")),
    (Q("0.2693528550631203"), Q("0.0209306631320388")),
    (Q("0.7306471449368797"), Q("0.0209306631320388")),
    (Q("0.2693528550631203"), Q("0.9790693368679612")),
    (Q("0.7306471449368797"), Q("0.9790693368679612")),
    (Q("0.2840548492782724"), Q("0.2307700013962074")),
    (Q("0.7159451507217276"), Q("0.2307700013962074")),
    (Q("0.2840548492782724"), Q("0.7692299986037926")),
    (Q("0.7159451507217276"), Q("0.7692299986037926")),
    (Q("0.5000000000000000"), Q("0.0372997380135319")),
    (Q("0.5000000000000000"), Q("0.9627002619864681")),
    (Q("0.5000000000000000"), Q("0.0422997380135431")),
    (Q("0.5000000000000000"), Q("0.9577002619864569")),
    (Q("0.5000000000000000"), Q("0.2920964574752694")),
    (Q("0.5000000000000000"), Q("0.7079035425247306")),
    (Q("0.0292271681810216"), Q("0.5000000000000000")),
    (Q("0.9707728318189784"), Q("0.5000000000000000")),
    (Q("0.2614231567103838"), Q("0.5000000000000000")),
    (Q("0.7385768432896162"), Q("0.5000000000000000")),
    (Q("0.2664231567103824"), Q("0.5000000000000000")),
    (Q("0.7335768432896176"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 33
assert len(set(LIGHTS)) == 33

WITNESS_POINT: Point = (Q("0.1963078114995842"), Q("0.3409488854934710"))
