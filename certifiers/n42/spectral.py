#!/usr/bin/env python3
"""Exact lower-bound certificate for a 42-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 384.1543
for the explicit 42-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0462140872044668"), Q("0.3014168229704750")),
    (Q("0.9537859127955332"), Q("0.3014168229704750")),
    (Q("0.0462140872044668"), Q("0.6985831770295250")),
    (Q("0.9537859127955332"), Q("0.6985831770295250")),
    (Q("0.0628635454382931"), Q("0.0155104370127101")),
    (Q("0.9371364545617069"), Q("0.0155104370127101")),
    (Q("0.0628635454382931"), Q("0.9844895629872899")),
    (Q("0.9371364545617069"), Q("0.9844895629872899")),
    (Q("0.0542682549270256"), Q("0.1444726148332790")),
    (Q("0.9457317450729744"), Q("0.1444726148332790")),
    (Q("0.0542682549270256"), Q("0.8555273851667210")),
    (Q("0.9457317450729744"), Q("0.8555273851667210")),
    (Q("0.2464811604055818"), Q("0.0214632308608127")),
    (Q("0.7535188395944182"), Q("0.0214632308608127")),
    (Q("0.2464811604055818"), Q("0.9785367691391873")),
    (Q("0.7535188395944182"), Q("0.9785367691391873")),
    (Q("0.2480018657170840"), Q("0.2239179737866846")),
    (Q("0.7519981342829160"), Q("0.2239179737866846")),
    (Q("0.2480018657170840"), Q("0.7760820262133154")),
    (Q("0.7519981342829160"), Q("0.7760820262133154")),
    (Q("0.5000000000000000"), Q("0.0371094255327782")),
    (Q("0.5000000000000000"), Q("0.9628905744672218")),
    (Q("0.5000000000000000"), Q("0.0381094236664666")),
    (Q("0.5000000000000000"), Q("0.9618905763335334")),
    (Q("0.5000000000000000"), Q("0.0391094212187479")),
    (Q("0.5000000000000000"), Q("0.9608905787812521")),
    (Q("0.5000000000000000"), Q("0.0401094193757950")),
    (Q("0.5000000000000000"), Q("0.9598905806242050")),
    (Q("0.5000000000000000"), Q("0.2579076620960186")),
    (Q("0.5000000000000000"), Q("0.7420923379039814")),
    (Q("0.5000000000000000"), Q("0.3389085036637353")),
    (Q("0.5000000000000000"), Q("0.6610914963362647")),
    (Q("0.0549844543642950"), Q("0.5000000000000000")),
    (Q("0.9450155456357050"), Q("0.5000000000000000")),
    (Q("0.0559846861763721"), Q("0.5000000000000000")),
    (Q("0.9440153138236279"), Q("0.5000000000000000")),
    (Q("0.2001795386415342"), Q("0.5000000000000000")),
    (Q("0.7998204613584658"), Q("0.5000000000000000")),
    (Q("0.2858821393513143"), Q("0.5000000000000000")),
    (Q("0.7141178606486857"), Q("0.5000000000000000")),
    (Q("0.3297613706449826"), Q("0.5000000000000000")),
    (Q("0.6702386293550174"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 42
assert len(set(LIGHTS)) == 42

WITNESS_POINT: Point = (Q("0.0000000000000000"), Q("0.2183113384022496"))
