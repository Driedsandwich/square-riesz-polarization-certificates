#!/usr/bin/env python3
"""Exact lower-bound certificate for a 20-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 174.6555
for the explicit 20-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0639722331186652"), Q("0.0639722331186652")),
    (Q("0.9360277668813348"), Q("0.0639722331186652")),
    (Q("0.0639722331186652"), Q("0.9360277668813348")),
    (Q("0.9360277668813348"), Q("0.9360277668813348")),
    (Q("0.0714636614261572"), Q("0.2805475524847453")),
    (Q("0.9285363385738428"), Q("0.2805475524847453")),
    (Q("0.0714636614261572"), Q("0.7194524475152547")),
    (Q("0.9285363385738428"), Q("0.7194524475152547")),
    (Q("0.2805475524847453"), Q("0.0714636614261572")),
    (Q("0.7194524475152547"), Q("0.0714636614261572")),
    (Q("0.2805475524847453"), Q("0.9285363385738428")),
    (Q("0.7194524475152547"), Q("0.9285363385738428")),
    (Q("0.3636174817407996"), Q("0.3636174817407996")),
    (Q("0.6363825182592004"), Q("0.3636174817407996")),
    (Q("0.3636174817407996"), Q("0.6363825182592004")),
    (Q("0.6363825182592004"), Q("0.6363825182592004")),
    (Q("0.5000000000000000"), Q("0.0745457349610708")),
    (Q("0.5000000000000000"), Q("0.9254542650389292")),
    (Q("0.0745457349610708"), Q("0.5000000000000000")),
    (Q("0.9254542650389292"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 20
assert len(set(LIGHTS)) == 20

WITNESS_POINT: Point = (Q("0.5000000000000000"), Q("0.5000000000000000"))
