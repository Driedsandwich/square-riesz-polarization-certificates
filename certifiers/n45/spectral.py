#!/usr/bin/env python3
"""Exact lower-bound certificate for a 45-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 403.2479
for the explicit 45-point configuration below.
