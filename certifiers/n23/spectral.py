#!/usr/bin/env python3
"""Exact lower-bound certificate for a 23-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 205.7568
for the explicit 23-point configuration below.
