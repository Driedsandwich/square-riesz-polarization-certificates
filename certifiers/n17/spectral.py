#!/usr/bin/env python3
"""Exact lower-bound certificate for a 17-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 134.8597
for the explicit 17-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0861817004883419"), Q("0.0559506445380746")),
    (Q("0.9077205159488284"), Q("0.0464628194448384")),
    (Q("0.0851911067025001"), Q("0.9410668554819868")),
    (Q("0.9173013785064548"), Q("0.9372370082950533")),
    (Q("0.3590535664214353"), Q("0.0473229154696009")),
    (Q("0.6362623014215779"), Q("0.0629506467755148")),
    (Q("0.3604811521600588"), Q("0.9488361195607158")),
    (Q("0.6432361560784791"), Q("0.9467576941287122")),
    (Q("0.0616914503276103"), Q("0.2998335587229522")),
    (Q("0.9274196902761936"), Q("0.2782601564662863")),
    (Q("0.1157653760635336"), Q("0.7344163968705778")),
    (Q("0.8749602484315111"), Q("0.7406524932259448")),
    (Q("0.3794649586520961"), Q("0.3533483759990582")),
    (Q("0.4938353222040420"), Q("0.6628306540048662")),
    (Q("0.1133048269511152"), Q("0.5370919592552212")),
    (Q("0.9123971677902634"), Q("0.5337819021143172")),
    (Q("0.6422024119925215"), Q("0.4101699120268502")),
]
assert len(LIGHTS) == 17
assert len(set(LIGHTS)) == 17

WITNESS_POINT: Point = (Q("0.5213648595915684"), Q("0.2089693108665215"))
