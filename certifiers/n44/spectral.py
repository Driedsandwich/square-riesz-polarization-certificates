#!/usr/bin/env python3
"""Exact lower-bound certificate for a 44-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 397.3562
for the explicit 44-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0400594128176527"), Q("0.2890815202162291")),
    (Q("0.9599405871823473"), Q("0.2890815202162291")),
    (Q("0.0400594128176527"), Q("0.7109184797837709")),
    (Q("0.9599405871823473"), Q("0.7109184797837709")),
    (Q("0.0630207338335247"), Q("0.0127308682913352")),
    (Q("0.9369792661664753"), Q("0.0127308682913352")),
    (Q("0.0630207338335247"), Q("0.9872691317086648")),
    (Q("0.9369792661664753"), Q("0.9872691317086648")),
    (Q("0.0584327056969281"), Q("0.1349715085823344")),
    (Q("0.9415672943030719"), Q("0.1349715085823344")),
    (Q("0.0584327056969281"), Q("0.8650284914176656")),
    (Q("0.9415672943030719"), Q("0.8650284914176656")),
    (Q("0.2464701815990841"), Q("0.0194401540072625")),
    (Q("0.7535298184009159"), Q("0.0194401540072625")),
    (Q("0.2464701815990841"), Q("0.9805598459927375")),
    (Q("0.7535298184009159"), Q("0.9805598459927375")),
    (Q("0.2513220385071279"), Q("0.2210481605745068")),
    (Q("0.7486779614928721"), Q("0.2210481605745068")),
    (Q("0.2513220385071279"), Q("0.7789518394254932")),
    (Q("0.7486779614928721"), Q("0.7789518394254932")),
    (Q("0.5000000000000000"), Q("0.0301080897912315")),
    (Q("0.5000000000000000"), Q("0.9698919102087685")),
    (Q("0.5000000000000000"), Q("0.0311080875924688")),
    (Q("0.5000000000000000"), Q("0.9688919124075312")),
    (Q("0.5000000000000000"), Q("0.0321080846927038")),
    (Q("0.5000000000000000"), Q("0.9678919153072962")),
    (Q("0.5000000000000000"), Q("0.0331080825487024")),
    (Q("0.5000000000000000"), Q("0.9668919174512976")),
    (Q("0.5000000000000000"), Q("0.2443533315862328")),
    (Q("0.5000000000000000"), Q("0.7556466684137672")),
    (Q("0.5000000000000000"), Q("0.2896836047103363")),
    (Q("0.5000000000000000"), Q("0.7103163952896637")),
    (Q("0.0441779508156511"), Q("0.5000000000000000")),
    (Q("0.9558220491843489"), Q("0.5000000000000000")),
    (Q("0.0451779505532552"), Q("0.5000000000000000")),
    (Q("0.9548220494467448"), Q("0.5000000000000000")),
    ...
    (Q("0.3357802969561243"), Q("0.5000000000000000")),
    (Q("0.6642197030438757"), Q("0.5000000000000000")),
    (Q("0.3367802968975130"), Q("0.5000000000000000")),
    (Q("0.6632197031024870"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 44
assert len(set(LIGHTS)) == 44

WITNESS_POINT: Point = (Q("0.0000000000000000"), Q("0.2024318241145156"))
