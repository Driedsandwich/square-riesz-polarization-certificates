#!/usr/bin/env python3
"""Exact lower-bound certificate for a 18-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 147.3404
for the explicit 18-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0925415033290291"), Q("0.0364699237144913")),
    (Q("0.9074584966709709"), Q("0.0364699237144913")),
    (Q("0.0925415033290291"), Q("0.9635300762855087")),
    (Q("0.9074584966709709"), Q("0.9635300762855087")),
    (Q("0.3633047184811564"), Q("0.0450920475312607")),
    (Q("0.6366952815188436"), Q("0.0450920475312607")),
    (Q("0.3633047184811564"), Q("0.9549079524687393")),
    (Q("0.6366952815188436"), Q("0.9549079524687393")),
    (Q("0.0678398619547126"), Q("0.2534009011862120")),
    (Q("0.9321601380452874"), Q("0.2534009011862120")),
    (Q("0.0678398619547126"), Q("0.7465990988137880")),
    (Q("0.9321601380452874"), Q("0.7465990988137880")),
    (Q("0.3682169298761830"), Q("0.3381773062273398")),
    (Q("0.6317830701238170"), Q("0.3381773062273398")),
    (Q("0.3682169298761830"), Q("0.6618226937726602")),
    (Q("0.6317830701238170"), Q("0.6618226937726602")),
    (Q("0.0757865919857292"), Q("0.5000000000000000")),
    (Q("0.9242134080142708"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 18
assert len(set(LIGHTS)) == 18

WITNESS_POINT: Point = (Q("0.5000000000000000"), Q("0.0000000000000000"))
