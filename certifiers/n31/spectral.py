#!/usr/bin/env python3
"""Exact lower-bound certificate for a 31-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 294.2086
for the explicit 31-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0682982666328550"), Q("0.3309694810293186")),
    (Q("0.9317017333671450"), Q("0.3309694810293186")),
    (Q("0.0682982666328550"), Q("0.6690305189706814")),
    (Q("0.9317017333671450"), Q("0.6690305189706814")),
    (Q("0.0683132612687186"), Q("0.0233191569682911")),
    (Q("0.9316867387312814"), Q("0.0233191569682911")),
    (Q("0.0683132612687186"), Q("0.9766808430317089")),
    (Q("0.9316867387312814"), Q("0.9766808430317089")),
    (Q("0.0630953421054538"), Q("0.1697673684383428")),
    (Q("0.9369046578945462"), Q("0.1697673684383428")),
    (Q("0.0630953421054538"), Q("0.8302326315616572")),
    (Q("0.9369046578945462"), Q("0.8302326315616572")),
    (Q("0.2690058184536450"), Q("0.0287302426164156")),
    (Q("0.7309941815463550"), Q("0.0287302426164156")),
    (Q("0.2690058184536450"), Q("0.9712697573835844")),
    (Q("0.7309941815463550"), Q("0.9712697573835844")),
    (Q("0.2884699965319872"), Q("0.2521849013356093")),
    (Q("0.7115300034680128"), Q("0.2521849013356093")),
    (Q("0.2884699965319872"), Q("0.7478150986643907")),
    (Q("0.7115300034680128"), Q("0.7478150986643907")),
    (Q("0.5000000000000000"), Q("0.0447412717071796")),
    (Q("0.5000000000000000"), Q("0.9552587282928204")),
    (Q("0.5000000000000000"), Q("0.0497412717071796")),
    (Q("0.5000000000000000"), Q("0.9502587282928204")),
    (Q("0.5000000000000000"), Q("0.3171022024766202")),
    (Q("0.5000000000000000"), Q("0.6828977975233798")),
    (Q("0.0562249255911605"), Q("0.5000000000000000")),
    (Q("0.9437750744088395"), Q("0.5000000000000000")),
    (Q("0.2688716201508384"), Q("0.5000000000000000")),
    (Q("0.7311283798491616"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 31
assert len(set(LIGHTS)) == 31

WITNESS_POINT: Point = (Q("0.0000000000000000"), Q("0.2530388211848563"))
