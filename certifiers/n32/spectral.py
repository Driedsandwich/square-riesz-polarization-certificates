#!/usr/bin/env python3
"""Exact lower-bound certificate for a 32-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 304.2807
for the explicit 32-point configuration below.
