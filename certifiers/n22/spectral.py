#!/usr/bin/env python3
"""Exact lower-bound certificate for a 22-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 195.0509
for the explicit 22-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.05475877114624413"), Q("0.06607907700329602")),
    (Q("0.94524122885375587"), Q("0.06607907700329602")),
    (Q("0.05475877114624413"), Q("0.93392092299670398")),
    (Q("0.94524122885375587"), Q("0.93392092299670398")),
    (Q("0.26655718953276247"), Q("0.04791793249081343")),
    (Q("0.73344281046723753"), Q("0.04791793249081343")),
    (Q("0.26655718953276247"), Q("0.95208206750918657")),
    (Q("0.73344281046723753"), Q("0.95208206750918657")),
    (Q("0.06149647708120755"), Q("0.27914999010482933")),
    (Q("0.93850352291879245"), Q("0.27914999010482933")),
    (Q("0.06149647708120755"), Q("0.72085000989517067")),
    (Q("0.93850352291879245"), Q("0.72085000989517067")),
    (Q("0.34888282679909566"), Q("0.29081888082645030")),
    (Q("0.65111717320090434"), Q("0.29081888082645030")),
    (Q("0.34888282679909566"), Q("0.70918111917354970")),
    (Q("0.65111717320090434"), Q("0.70918111917354970")),
    (Q("0.50000000000000000"), Q("0.04771498547831616")),
    (Q("0.50000000000000000"), Q("0.95228501452168384")),
    (Q("0.05745409614646466"), Q("0.50000000000000000")),
    (Q("0.94254590385353534"), Q("0.50000000000000000")),
    (Q("0.33923860059242816"), Q("0.50000000000000000")),
    (Q("0.66076139940757184"), Q("0.50000000000000000")),
]
assert len(LIGHTS) == 22
assert len(set(LIGHTS)) == 22
