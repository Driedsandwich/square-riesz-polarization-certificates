#!/usr/bin/env python3
"""Exact lower-bound certificate for a 26-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 241.2678
for the explicit 26-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0757142075496832"), Q("0.4125090368983633")),
    (Q("0.9242857924503168"), Q("0.4125090368983633")),
    (Q("0.0757142075496832"), Q("0.5874909631016367")),
    (Q("0.9242857924503168"), Q("0.5874909631016367")),
    (Q("0.0600211613806377"), Q("0.0497212582267132")),
    (Q("0.9399788386193623"), Q("0.0497212582267132")),
    (Q("0.0600211613806377"), Q("0.9502787417732868")),
    (Q("0.9399788386193623"), Q("0.9502787417732868")),
    (Q("0.0647530106806267"), Q("0.2314063343037808")),
    (Q("0.9352469893193733"), Q("0.2314063343037808")),
    (Q("0.0647530106806267"), Q("0.7685936656962192")),
    (Q("0.9352469893193733"), Q("0.7685936656962192")),
    (Q("0.2429679341610983"), Q("0.0731910207615881")),
    (Q("0.7570320658389017"), Q("0.0731910207615881")),
    (Q("0.2429679341610983"), Q("0.9268089792384119")),
    (Q("0.7570320658389017"), Q("0.9268089792384119")),
    (Q("0.3020084248368963"), Q("0.3560653849675190")),
    (Q("0.6979915751631037"), Q("0.3560653849675190")),
    (Q("0.3020084248368963"), Q("0.6439346150324810")),
    (Q("0.6979915751631037"), Q("0.6439346150324810")),
    (Q("0.4149673217303189"), Q("0.0781575068175997")),
    (Q("0.5850326782696811"), Q("0.0781575068175997")),
    (Q("0.4149673217303189"), Q("0.9218424931824003")),
    (Q("0.5850326782696811"), Q("0.9218424931824003")),
    (Q("0.5000000000000000"), Q("0.3625395491035396")),
    (Q("0.5000000000000000"), Q("0.6374604508964604")),
]
assert len(LIGHTS) == 26
assert len(set(LIGHTS)) == 26

WITNESS_POINT: Point = (Q("0.1610364421223604"), Q("1.0000000000000000"))
