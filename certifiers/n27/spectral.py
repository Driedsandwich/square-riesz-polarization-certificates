#!/usr/bin/env python3
"""Exact lower-bound certificate for a 27-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 252.6450
for the explicit 27-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0473984933821328"), Q("0.3986846327153466")),
    (Q("0.9526015066178672"), Q("0.3986846327153466")),
    (Q("0.0473984933821328"), Q("0.6013153672846534")),
    (Q("0.9526015066178672"), Q("0.6013153672846534")),
    (Q("0.0706490877569628"), Q("0.0300371717958281")),
    (Q("0.9293509122430372"), Q("0.0300371717958281")),
    (Q("0.0706490877569628"), Q("0.9699628282041719")),
    (Q("0.9293509122430372"), Q("0.9699628282041719")),
    (Q("0.0513624468359587"), Q("0.1998618292241061")),
    (Q("0.9486375531640413"), Q("0.1998618292241061")),
    (Q("0.0513624468359587"), Q("0.8001381707758939")),
    (Q("0.9486375531640413"), Q("0.8001381707758939")),
    (Q("0.2812541543993108"), Q("0.0311089999279894")),
    (Q("0.7187458456006892"), Q("0.0311089999279894")),
    (Q("0.2812541543993108"), Q("0.9688910000720106")),
    (Q("0.7187458456006892"), Q("0.9688910000720106")),
    (Q("0.2806988312453062"), Q("0.2596164602720649")),
    (Q("0.7193011687546938"), Q("0.2596164602720649")),
    (Q("0.2806988312453062"), Q("0.7403835397279351")),
    (Q("0.7193011687546938"), Q("0.7403835397279351")),
    (Q("0.5000000000000000"), Q("0.2401700863887715")),
    (Q("0.5000000000000000"), Q("0.7598299136112285")),
    (Q("0.5000000000000000"), Q("0.0258149639534658")),
    (Q("0.5000000000000000"), Q("0.9741850360465342")),
    (Q("0.2845140081678028"), Q("0.5000000000000000")),
    (Q("0.7154859918321972"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 27
assert len(set(LIGHTS)) == 27

WITNESS_POINT: Point = (Q("0.0000000000000000"), Q("0.1006238701982223"))
