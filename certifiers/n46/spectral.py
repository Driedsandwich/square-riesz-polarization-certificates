#!/usr/bin/env python3
"""Exact lower-bound certificate for a 46-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 413.3754
for the explicit 46-point configuration below.
