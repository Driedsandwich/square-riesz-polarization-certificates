#!/usr/bin/env python3
"""Second exact rational certificate for the same fixed 10-light configuration.
...
ZERO=Q(0);ONE=Q(1);TARGET=Q("62.4087")
Point=tuple[Q,Q];Box=tuple[Q,Q,Q,Q]
LIGHTS=[
(Q("0.10932786038755711"),Q("0.09937446880454025")),
(Q("0.89067213961244289"),Q("0.09937446880454025")),
(Q("0.08393559438831978"),Q("0.87624574843037210")),
(Q("0.91606440561168022"),Q("0.87624574843037210")),
(Q("0.04323588003757157"),Q("0.47695955607655750")),
(Q("0.95676411996242843"),Q("0.47695955607655750")),
(Q("0.50000000000000000"),Q("0.01952929879863202")),
(Q("0.50000000000000000"),Q("0.89040974624747200")),
(Q("0.50000000000000000"),Q("0.43145837235946793")),
(Q("0.50000000000000000"),Q("0.89140974624747200")),
]
assert len(LIGHTS)==10 and len(set(LIGHTS))==10
