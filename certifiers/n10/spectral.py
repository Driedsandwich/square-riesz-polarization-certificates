#!/usr/bin/env python3
"""Exact rational lower-bound certificate for a 10-light square configuration.

For the literal decimal coordinates below, this program proves
    min_{p in [0,1]^2} sum_i 1/||p-c_i||^2 >= 62.4087.
...
PARAMETERS={
    "x1":Q("0.10932786038755711"), "y1":Q("0.09937446880454025"),
    "x2":Q("0.08393559438831978"), "y2":Q("0.87624574843037210"),
    "x3":Q("0.04323588003757157"), "y3":Q("0.47695955607655750"),
    "a1":Q("0.01952929879863202"),
    "a2":Q("0.89040974624747200"),
    "a3":Q("0.43145837235946793"),
    "a4":Q("0.89140974624747200"),
}
...
def build_lights()->list[Point]:
    ...
    L += [(HALF,PARAMETERS[k]) for k in ("a1","a2","a3","a4")]
    assert len(L)==10 and len(set(L))==10
