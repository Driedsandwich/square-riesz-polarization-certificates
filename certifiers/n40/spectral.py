#!/usr/bin/env python3
"""Exact lower-bound certificate for a 40-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 368.2623
for the explicit 40-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0456220003500649"), Q("0.2980725967758190")),
    (Q("0.9543779996499351"), Q("0.2980725967758190")),
    (Q("0.0456220003500649"), Q("0.7019274032241810")),
    (Q("0.9543779996499351"), Q("0.7019274032241810")),
    (Q("0.0642991693063612"), Q("0.0155177223937175")),
    (Q("0.9357008306936388"), Q("0.0155177223937175")),
    (Q("0.0642991693063612"), Q("0.9844822776062825")),
    (Q("0.9357008306936388"), Q("0.9844822776062825")),
    (Q("0.0610446134401197"), Q("0.1423436776016093")),
    (Q("0.9389553865598803"), Q("0.1423436776016093")),
    (Q("0.0610446134401197"), Q("0.8576563223983907")),
    (Q("0.9389553865598803"), Q("0.8576563223983907")),
    (Q("0.2518290203867718"), Q("0.0223380059381988")),
    (Q("0.7481709796132282"), Q("0.0223380059381988")),
    (Q("0.2518290203867718"), Q("0.9776619940618012")),
    (Q("0.7481709796132282"), Q("0.9776619940618012")),
    (Q("0.2571086000271732"), Q("0.2335717190044145")),
    (Q("0.7428913999728268"), Q("0.2335717190044145")),
    (Q("0.2571086000271732"), Q("0.7664282809955855")),
    (Q("0.7428913999728268"), Q("0.7664282809955855")),
    (Q("0.5000000000000000"), Q("0.0264171050528195")),
    (Q("0.5000000000000000"), Q("0.9735828949471805")),
    (Q("0.5000000000000000"), Q("0.0269163842194592")),
    (Q("0.5000000000000000"), Q("0.9730836157805408")),
    (Q("0.5000000000000000"), Q("0.0274162141023930")),
    (Q("0.5000000000000000"), Q("0.9725837858976070")),
    (Q("0.5000000000000000"), Q("0.1443533315862328")),
    (Q("0.5000000000000000"), Q("0.8556466684137672")),
    (Q("0.5000000000000000"), Q("0.3099748016333556")),
    (Q("0.5000000000000000"), Q("0.6900251983666444")),
    (Q("0.0551734857847801"), Q("0.5000000000000000")),
    (Q("0.9448265142152199"), Q("0.5000000000000000")),
    (Q("0.0567264384788312"), Q("0.5000000000000000")),
    (Q("0.9432735615211688"), Q("0.5000000000000000")),
    (Q("0.2062109330111482"), Q("0.5000000000000000")),
    (Q("0.7937890669888518"), Q("0.5000000000000000")),
    (Q("0.3326782382582542"), Q("0.5000000000000000")),
    (Q("0.6673217617417458"), Q("0.5000000000000000")),
    (Q("0.3341420740444352"), Q("0.5000000000000000")),
    (Q("0.6658579259555648"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 40
assert len(set(LIGHTS)) == 40

WITNESS_POINT: Point = (Q("0.0000000000000000"), Q("0.0708633059878408"))
