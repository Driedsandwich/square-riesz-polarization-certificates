#!/usr/bin/env python3
"""Exact lower-bound certificate for a 25-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 228.9185
for the explicit 25-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0619145723671528"), Q("0.3964915495675268")),
    (Q("0.9380854276328472"), Q("0.3964915495675268")),
    (Q("0.0619145723671528"), Q("0.6035084504324732")),
    (Q("0.9380854276328472"), Q("0.6035084504324732")),
    (Q("0.0657167815576798"), Q("0.0458246841451889")),
    (Q("0.9342832184423202"), Q("0.0458246841451889")),
    (Q("0.0657167815576798"), Q("0.9541753158548111")),
    (Q("0.9342832184423202"), Q("0.9541753158548111")),
    (Q("0.0822208306227462"), Q("0.2133185204303162")),
    (Q("0.9177791693772538"), Q("0.2133185204303162")),
    (Q("0.0822208306227462"), Q("0.7866814795696838")),
    (Q("0.9177791693772538"), Q("0.7866814795696838")),
    (Q("0.2797692898628314"), Q("0.0352573756198788")),
    (Q("0.7202307101371686"), Q("0.0352573756198788")),
    (Q("0.2797692898628314"), Q("0.9647426243801212")),
    (Q("0.7202307101371686"), Q("0.9647426243801212")),
    (Q("0.3605132449138650"), Q("0.2663438495440321")),
    (Q("0.6394867550861350"), Q("0.2663438495440321")),
    (Q("0.3605132449138650"), Q("0.7336561504559679")),
    (Q("0.6394867550861350"), Q("0.7336561504559679")),
    (Q("0.5000000000000000"), Q("0.0456959747165592")),
    (Q("0.5000000000000000"), Q("0.9543040252834408")),
    (Q("0.2327853116620228"), Q("0.5000000000000000")),
    (Q("0.7672146883379772"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 25
assert len(set(LIGHTS)) == 25

WITNESS_POINT: Point = (Q("1.0000000000000000"), Q("0.1376081012959503"))
