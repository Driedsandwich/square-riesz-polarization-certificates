#!/usr/bin/env python3
"""Exact lower-bound certificate for a 41-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 373.6041
for the explicit 41-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0460105000000000"), Q("0.2951420000000000")),
    (Q("0.9539895000000000"), Q("0.2951420000000000")),
    (Q("0.0460105000000000"), Q("0.7048580000000000")),
    (Q("0.9539895000000000"), Q("0.7048580000000000")),
    (Q("0.0653540400000000"), Q("0.0108041900000000")),
    (Q("0.9346459600000000"), Q("0.0108041900000000")),
    (Q("0.0653540400000000"), Q("0.9891958100000000")),
    (Q("0.9346459600000000"), Q("0.9891958100000000")),
    (Q("0.0570292200000000"), Q("0.1374240900000000")),
    (Q("0.9429707800000000"), Q("0.1374240900000000")),
    (Q("0.0570292200000000"), Q("0.8625759100000000")),
    (Q("0.9429707800000000"), Q("0.8625759100000000")),
    (Q("0.2543427800000000"), Q("0.0175114300000000")),
    (Q("0.7456572200000000"), Q("0.0175114300000000")),
    (Q("0.2543427800000000"), Q("0.9824885700000000")),
    (Q("0.7456572200000000"), Q("0.9824885700000000")),
    (Q("0.2536519900000000"), Q("0.2203486400000000")),
    (Q("0.7463480100000000"), Q("0.2203486400000000")),
    (Q("0.2536519900000000"), Q("0.7796513600000000")),
    (Q("0.7463480100000000"), Q("0.7796513600000000")),
    (Q("0.5000000000000000"), Q("0.0240094600000000")),
    (Q("0.5000000000000000"), Q("0.9759905400000000")),
    (Q("0.5000000000000000"), Q("0.0250092600000000")),
    (Q("0.5000000000000000"), Q("0.9749907400000000")),
    (Q("0.5000000000000000"), Q("0.0260097400000000")),
    (Q("0.5000000000000000"), Q("0.9739902600000000")),
    (Q("0.5000000000000000"), Q("0.2034573400000000")),
    (Q("0.5000000000000000"), Q("0.7965426600000000")),
    (Q("0.5000000000000000"), Q("0.2797855200000000")),
    (Q("0.5000000000000000"), Q("0.7202144800000000")),
    (Q("0.0480960600000000"), Q("0.5000000000000000")),
    (Q("0.9519039400000000"), Q("0.5000000000000000")),
    (Q("0.0491926900000000"), Q("0.5000000000000000")),
    (Q("0.9508073100000000"), Q("0.5000000000000000")),
    (Q("0.2139642500000000"), Q("0.5000000000000000")),
    (Q("0.7860357500000000"), Q("0.5000000000000000")),
    (Q("0.2924091300000000"), Q("0.5000000000000000")),
    (Q("0.7075908700000000"), Q("0.5000000000000000")),
    (Q("0.2934094200000000"), Q("0.5000000000000000")),
    (Q("0.7065905800000000"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 41
assert len(set(LIGHTS)) == 41

WITNESS_POINT: Point = (Q("0.1601352188165799"), Q("0.0000000000000000"))
