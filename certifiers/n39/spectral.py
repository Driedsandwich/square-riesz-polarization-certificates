#!/usr/bin/env python3
"""Exact lower-bound certificate for a 39-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 360.2833
for the explicit 39-point configuration below.
...
LIGHTS: list[Point] = [
    (Q("0.0465372410509131"), Q("0.3044624635356324")),
    (Q("0.9534627589490869"), Q("0.3044624635356324")),
    (Q("0.0465372410509131"), Q("0.6955375364643676")),
    (Q("0.9534627589490869"), Q("0.6955375364643676")),
    (Q("0.0639364368147451"), Q("0.0182413563984466")),
    (Q("0.9360635631852549"), Q("0.0182413563984466")),
    (Q("0.0639364368147451"), Q("0.9817586436015534")),
    (Q("0.9360635631852549"), Q("0.9817586436015534")),
    (Q("0.0615924328000267"), Q("0.1476588886673490")),
    (Q("0.9384075671999733"), Q("0.1476588886673490")),
    (Q("0.0615924328000267"), Q("0.8523411113326510")),
    (Q("0.9384075671999733"), Q("0.8523411113326510")),
    (Q("0.2516594184109309"), Q("0.0240083824194401")),
    (Q("0.7483405815890691"), Q("0.0240083824194401")),
    (Q("0.2516594184109309"), Q("0.9759916175805599")),
    (Q("0.7483405815890691"), Q("0.9759916175805599")),
    (Q("0.2579382839022888"), Q("0.2398810813728752")),
    (Q("0.7420617160977112"), Q("0.2398810813728752")),
    (Q("0.2579382839022888"), Q("0.7601189186271248")),
    (Q("0.7420617160977112"), Q("0.7601189186271248")),
    (Q("0.5000000000000000"), Q("0.0283667963309505")),
    (Q("0.5000000000000000"), Q("0.9716332036690495")),
    (Q("0.5000000000000000"), Q("0.0290383819755858")),
    (Q("0.5000000000000000"), Q("0.9709616180244142")),
    (Q("0.5000000000000000"), Q("0.0307795900867337")),
    (Q("0.5000000000000000"), Q("0.9692204099132663")),
    (Q("0.5000000000000000"), Q("0.1579076620960186")),
    (Q("0.5000000000000000"), Q("0.8420923379039814")),
    (Q("0.5000000000000000"), Q("0.3221095263973006")),
    (Q("0.5000000000000000"), Q("0.6778904736026994")),
    (Q("0.0517350385782046"), Q("0.5000000000000000")),
    (Q("0.9482649614217954"), Q("0.5000000000000000")),
    (Q("0.0796534988513965"), Q("0.5000000000000000")),
    (Q("0.9203465011486035"), Q("0.5000000000000000")),
    (Q("0.2787479032957782"), Q("0.5000000000000000")),
    (Q("0.7212520967042218"), Q("0.5000000000000000")),
    (Q("0.2818641499402945"), Q("0.5000000000000000")),
    (Q("0.7181358500597055"), Q("0.5000000000000000")),
    (Q("0.5000000000000000"), Q("0.5000000000000000")),
]
assert len(LIGHTS) == 39
assert len(set(LIGHTS)) == 39

WITNESS_POINT: Point = (Q("0.1884376357051427"), Q("0.1289761623080245"))
