#!/usr/bin/env python3
"""Second exact rational certificate for the same fixed 8-light configuration.
...
ZERO=Q(0);ONE=Q(1);TARGET=Q("47.8390")
Point=tuple[Q,Q];Box=tuple[Q,Q,Q,Q]
LIGHTS=[
(Q("0.11901099543098309"),Q("0.11901099543098309")),
(Q("0.88098900456901691"),Q("0.11901099543098309")),
(Q("0.11901099543098309"),Q("0.88098900456901691")),
(Q("0.88098900456901691"),Q("0.88098900456901691")),
(Q("0.50000000000000000"),Q("0.15730761919588385")),
(Q("0.50000000000000000"),Q("0.84269238080411615")),
(Q("0.15730761919588385"),Q("0.50000000000000000")),
(Q("0.84269238080411615"),Q("0.50000000000000000")),
]
assert len(LIGHTS)==8 and len(set(LIGHTS))==8
assert set(LIGHTS)=={(ONE-x,y) for x,y in LIGHTS}
assert set(LIGHTS)=={(x,ONE-y) for x,y in LIGHTS}
assert set(LIGHTS)=={(y,x) for x,y in LIGHTS}
