#!/usr/bin/env python3
"""Second exact rational certificate for the same fixed 7-light configuration.
...
ZERO=Q(0);ONE=Q(1);TARGET=Q("35.9098")
Point=tuple[Q,Q];Box=tuple[Q,Q,Q,Q]
LIGHTS=[
(Q("0.08313859725419892"),Q("0.82422400036103727")),
(Q("0.91686140274580108"),Q("0.82422400036103727")),
(Q("0.20830208711815607"),Q("0.00776367313760921")),
(Q("0.79169791288184393"),Q("0.00776367313760921")),
(Q("0.16404756694403380"),Q("0.34275427568218059")),
(Q("0.83595243305596620"),Q("0.34275427568218059")),
(Q("0.50000000000000000"),Q("0.84685581134922150")),
]
assert len(LIGHTS)==7 and len(set(LIGHTS))==7
