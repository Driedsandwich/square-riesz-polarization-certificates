#!/usr/bin/env python3
"""Exact lower-bound certificate for a 15-light configuration in the unit square.
...
This script certifies, using exact rational arithmetic, that
    min_{p in [0,1]^2} F(p) >= 115.1635457
for the explicit 15-point configuration below.
