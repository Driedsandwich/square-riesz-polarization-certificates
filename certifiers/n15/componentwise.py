#!/usr/bin/env python3
"""Independent exact certificate using componentwise Hessian intervals.
...
This verifier uses a different rigorous second-order remainder bound from the companion spectral verifier:
...
ZERO=Q(0); ONE=Q(1)
TARGET=Q("115.1635457")
Point=tuple[Q,Q]
Box=tuple[Q,Q,Q,Q]
LIGHTS: list[Point] = [
    (Q("0.34932296863252893"), Q("0.06244894199502463")),
    (Q("0.65067703136747101"), Q("0.06244894199502463")),
    (Q("0.07385573674624343"), Q("0.08225267976220411")),
    (Q("0.92614426325375654"), Q("0.08225267976220411")),
    (Q("0.09588193372280092"), Q("0.34235954643707345")),
    (Q("0.90411806627719904"), Q("0.34235954643707345")),
    (Q("0.35094132657157345"), Q("0.60890546913158716")),
    (Q("0.64905867342842649"), Q("0.60890546913158716")),
    (Q("0.03113249013142547"), Q("0.62898078959458892")),
    (Q("0.96886750986857451"), Q("0.62898078959458892")),
    (Q("0.07484209060709861"), Q("0.91899758748999572")),
    (Q("0.92515790939290143"), Q("0.91899758748999572")),
    (Q("0.35046982151521722"), Q("0.94209081913633674")),
    (Q("0.64953017848478278"), Q("0.94209081913633674")),
    (Q("0.50000000000000000"), Q("0.32024931744429214")),
]
assert len(LIGHTS)==15
assert len(set(LIGHTS))==15
UPPER_WITNESS: Point = (Q("1"), Q("0.4649058787163152"))
...
def main()->None:
    result=certify()
    witness=potential_and_gradient(UPPER_WITNESS)[0]
    ...
    print("upper_witness_point:", "(1, 0.4649058787163152)")
